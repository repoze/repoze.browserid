# -*- coding: utf-8 -*-
#
# repoze.browserid documentation build configuration file
#
...
htmlhelp_basename = 'browseriddoc'
...
latex_documents = [
  ('index', 'browserid.tex', 'repoze.browserid Documentation',
